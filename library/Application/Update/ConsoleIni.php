...
class Application_Update_ConsoleIni extends Application_Update_PluginAbstract
{
    ...
    const DEFAULT_ADMIN_USER = 'opus4admin';

    const CONSOLE_INI_PATH = '/application/configs/console.ini';

    const CONSOLE_INI_TEMPLATE_PATH = '/application/configs/console.ini.template';
