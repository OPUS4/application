...
/**
 * Select element listing available field types.
 *
 * Currently this is used only for enrichments.
 */
class Application_Form_Element_FieldType extends Application_Form_Element_SelectWithNull
{
    public function init()
    {
        ...
        $this->setMultiOptions($availableTypes);
    }
}
