...
#
# Options:
#   -b  : To backup the old fulltext files before rebuilding
#   -v  : For additional output
#
...
pwd
ls -aux ../solr-9.10.1/server/solr/opus4/conf
cat ../application/configs/config.ini | grep solrsearch
