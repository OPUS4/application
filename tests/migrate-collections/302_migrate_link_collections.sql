INSERT INTO link_documents_collections(document_id, collection_id, role_id, link_type)
SELECT l.documents_id, c.id, c.role_id, l.role FROM collections AS c, link_documents_collections_1 AS l WHERE c.role_id = 1 AND c.oldid = l.collections_id;
