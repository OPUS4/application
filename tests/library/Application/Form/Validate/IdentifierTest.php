...
class Application_Form_Validate_IdentifierTest extends ControllerTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->element = new Application_Form_Element_Identifier('Element');
        $this->element->setValue('ISBN');
        $this->validator = new Application_Form_Validate_Identifier($this->element);
        $this->useEnglish();
    }
    ...
    {
        $this->assertTrue($this->validator->isValid('978-3-86680-192-9'));
        $this->assertTrue($this->validator->isValid('978 3 86680 192 9'));
        $this->assertTrue($this->validator->isValid('978-0-13235-088-4'));
        $this->assertTrue($this->validator->isValid('0 13235 088 2'));
        $this->assertTrue($this->validator->isValid('0-13235-088-2'));
    }
    ...
    {
        $this->assertFalse($this->validator->isValid('978-3-86680-192-3'));
        $this->assertFalse($this->validator->isValid('978-0-13235-088-8'));
    }
    ...
    {
        $this->assertFalse($this->validator->isValid('978-3-86680-192'));
        $this->assertFalse($this->validator->isValid('978-3-8668X-192'));
        $this->assertFalse($this->validator->isValid('978-3-866800-1942-34'));
        $this->assertFalse($this->validator->isValid('9748-3-866800-1942-34'));
        $this->assertFalse($this->validator->isValid('978-3-86680-19X-9'));
        $this->assertFalse($this->validator->isValid('978-378-866800-1942'));
        $this->assertFalse($this->validator->isValid('978386680192'));
        $this->assertFalse($this->validator->isValid('978-0 13235 088 4'));
    }
    ...
    public function testIsValidDoi()
    {
        $this->element->setValue('DOI');
        $this->validator = new Application_Form_Validate_Identifier($this->element);
        $this->assertTrue($this->validator->isValid('23356'));
        $this->assertTrue($this->validator->isValid('233dfsfsf'));
        $this->assertTrue($this->validator->isValid('23fdt45356'));
        $this->assertTrue($this->validator->isValid('233_:()$&56'));
        $this->assertTrue($this->validator->isValid('23!"356'));
    }
    ...
    public function testIsValidElementNull()
    {
        ...
        $this->expectExceptionMessage('Argument must not be NULL');
        $this->validator = new Application_Form_Validate_Identifier(null);
    }
    ...
    {
        $this->assertFalse($this->validator->isValid('978-3-86680-192-3'));
        $this->assertContains('checkdigit', $this->validator->getErrors());

        $this->assertFalse($this->validator->isValid('978-3-86680-192-7'));
        $this->assertContains("The check digit of '978-3-86680-192-7' is not valid.", $this->validator->getMessages());
    }
    ...
    {
        $this->assertFalse($this->validator->isValid('978-3-866800-1942-34'));
        $this->assertContains('form', $this->validator->getErrors());
        $this->assertContains("'978-3-866800-1942-34' is malformed.", $this->validator->getMessages());

        $this->assertFalse($this->validator->isValid('978386680192'));
        $this->assertContains('form', $this->validator->getErrors());
        $this->assertContains("'978386680192' is malformed.", $this->validator->getMessages());

        $this->assertFalse($this->validator->isValid('978-3-86680-1X2-9'));
        $this->assertContains('form', $this->validator->getErrors());
        $this->assertContains("'978-3-86680-1X2-9' is malformed.", $this->validator->getMessages());
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('Object must be Zend_Form_Element');
