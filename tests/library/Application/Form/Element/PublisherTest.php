...
class Application_Form_Element_PublisherTest extends FormElementTestCase
{
    ...
    {
        $this->formElementClass       = 'Application_Form_Element_Publisher';
    ...
    public function testSetValueForNonPublisherInstitut()
    {
        $element = $this->getElement();
        ...
        $this->assertGreaterThan(0, count($nonPublishers));

        $institute = $nonPublishers[0];
        ...
        $this->assertTrue($element->isValid($publishers[0]->getId()));
    ...
    public function testSetValueInstituteNotAddedTwice()
    {
        ...
        $element->setValue($publishers[0]->getId());
