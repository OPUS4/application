...
class Application_View_Helper_FaqEditLinkTest extends ControllerTestCase
{
    /** @var string */
    protected $additionalResources = 'all';

    public function testRenderFaqEditLink()
    {
    ...
    /**
     * @return Application_View_Helper_FaqEditLink
     */
