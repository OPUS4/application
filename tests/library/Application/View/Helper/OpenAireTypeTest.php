...
class Application_View_Helper_OpenAireTypeTest extends ControllerTestCase
{
    ...
    {
        $this->assertEquals($name, $this->helper->openAireType($type));
    }

    public function testOpenAireTypeForNull()
    {
        $this->assertEquals('other', $this->helper->openAireType(null));
    }

    public function testOpenAireTypeForEmpty()
    {
        $this->assertEquals('other', $this->helper->openAireType(''));
    }
}
