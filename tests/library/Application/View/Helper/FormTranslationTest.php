...
class Application_View_Helper_FormTranslationTest extends ControllerTestCase
{
    ...
    public function testRenderingOptions()
    {
        ...
        $this->assertEquals(
            '<label><span>English</span><input type="text" name="DisplayName[en]" id="DisplayName-en"'
            . ' value="English" /></label><br />' . "\n"
            . '<label><span>German</span><input type="text" name="DisplayName[de]" id="DisplayName-de"'
            . ' value="Deutsch" /></label>',
            $output
        );
    }

    public function testRenderingMore()
    {
        $this->markTestIncomplete('more testing possible');
    }
}
