 ...
 */
class Form_Validate_LanguageUsedOnceOnlyTest extends ControllerTestCase {
    ...
    public function testIsValidTrue() {
        $validator = new Form_Validate_LanguageUsedOnceOnly($this->selectedLanguages, 2);
    ...
    public function testIsValidFalse() {
        $validator = new Form_Validate_LanguageUsedOnceOnly($this->selectedLanguages, 3);
        
        $this->assertFalse($validator->isValid('deu'));
    }
    
    public function testIsValidFalse3rdOccurence() {
        $validator = new Form_Validate_LanguageUsedOnceOnly($this->selectedLanguages, 5);
    ...
    public function testLanguagesNullAlwaysReturnsTrue() {
        $validator = new Form_Validate_LanguageUsedOnceOnly(null, 0);
