...
/**
 * Class Form_Validate_AtLeastOneNotEmptyTest
 *
 * @category    Application Unit Test
 * @package     Form_Validate
 */
class Form_Validate_AtLeastOneNotEmptyTest extends ControllerTestCase {

    private $_validator;

    public function setUp() {
        parent::setUp();
        $this->_validator = new Form_Validate_AtLeastOneNotEmpty();
