...
class Form_Validate_OrcidTest extends ControllerTestCase {

    private $_validator;

    public function setUp() {
        parent::setUp();
        $this->_validator = new Form_Validate_Orcid();
    }
    ...
    public function testGenerateCheckDigit() {
        $this->assertEquals('7', Form_Validate_Orcid::generateCheckDigit('0000-0002-1825-009'));
        $this->assertEquals('X', Form_Validate_Orcid::generateCheckDigit('0000-0002-1825-010'));
    }
