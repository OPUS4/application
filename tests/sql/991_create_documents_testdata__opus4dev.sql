...
(155, NULL, 2011, NULL, NULL, '2011-02-26', 'report', NULL, NULL, 'eng', NULL, NULL, NULL, 'draft', NULL, 2011, '', NULL, '2011-06-04T02:36:53Z', '2011-03-05T09:47:22Z', 'published', NULL, 1);

--
-- Daten für Tabelle `document_files`
--

INSERT INTO `document_files` (`id`, `document_id`, `path_name`, `label`, `mime_type`, `language`, `file_size`, `visible_in_frontdoor`, `visible_in_oai`, `sort_order`) VALUES
(116, 91, 'test.pdf', 'test.pdf', 'application/pdf', 'eng', 6970, 1, 1, null ),
(117, 92, 'test.xhtml', 'test.xhtml', 'application/xhtml+xml', 'eng', 125, 1, 1, null),
(118, 93, 'test.txt', 'test.txt', 'text/plain', 'eng', 591, 1, 1, null ),
(119, 94, 'test.ps', 'test.ps', 'application/postscript', 'eng', 22041, 1, 1, null ),
(120, 95, 'test.html', 'test.html', 'text/html', 'eng', 847, 1, 1, null ),
(127, 91, 'test.txt', 'test.txt', 'text/plain', 'eng', 591, 1, 1, null ),
(128, 91, 'frontdoor_invisible.txt', 'frontdoor_invisible.txt', 'text/plain', 'eng', 591, 0, 1, null ),
(129, 91, 'oai_invisible.txt', 'oai_invisible.txt', 'text/plain', 'eng', 591, 1, 0, null ),
(132, 92, 'datei mit unüblichem Namen.xhtml', 'datei mit unüblichem Namen.xhtml', 'application/xhtml+xml', 'eng', 125, 1, 1, null ),
(133, 155, 'test.pdf', 'test.pdf', 'application/pdf', 'eng', 6970, 1, 1, 3 ),
(134, 155, 'test.txt', 'test.txt', 'text/plain', 'eng', 591, 1, 1, 2 ),
(135, 155, 'frontdoor_invisible.txt', 'frontdoor_invisible.txt', 'text/plain', 'eng', 591, 0, 1, 177 ),
(136, 155, 'oai_invisible.txt', 'oai_invisible.txt', 'text/plain', 'eng', 591, 1, 0, null );
...
(224, 91, 'main', 'This is a pdf test document', 'eng'),
(225, 91, 'abstract', 'This is a pdf test document', 'eng'),
(226, 92, 'main', 'This is a xhtml test document', 'eng'),
(227, 92, 'abstract', 'This is a xhtml test document', 'eng'),
(228, 93, 'main', 'This is a plain text test document', 'eng'),
(229, 93, 'abstract', 'This is a plain text test document', 'eng'),
(230, 94, 'main', 'This is a postscript test document', 'eng'),
(231, 94, 'abstract', 'This is a postscript test document', 'eng'),
(232, 95, 'main', 'This is a html test document', 'eng'),
(233, 95, 'abstract', 'This is a html test document', 'eng'),
(234, 96, 'main', 'This is an unpublished test document with $LaTeX - Code$ in it. For example, \\(\\sqrt{3x-1}+(1+x)^2\\) is an squareroot.', 'eng'),
(235, 97, 'main', 'This is another unpublished test document', 'eng'),
(236, 98, 'main', 'This is another unpublished document for testing purposes', 'eng'),
...
(271, 92, 'abstract', 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.', 'deu'),
(272, 92, 'abstract', 'Vestibulum volutpat pretium libero. Cras id dui. Aenean ut eros et nisl sagittis vestibulum. Nullam nulla eros, ultricies sit amet, nonummy id, imperdiet feugiat, pede. Sed lectus. Donec mollis hendrerit risus. Phasellus nec sem in justo pellentesque facilisis. Etiam imperdiet imperdiet orci. Nunc nec neque. Phasellus leo dolor, tempus non, auctor et, hendrerit quis, nisi. Curabitur ligula sapien, tincidunt non, euismod vitae, posuere imperdiet, leo. Maecenas malesuada. Praesent congue erat at massa. Sed cursus turpis vitae tortor. Donec posuere vulputate arcu. Phasellus accumsan cursus velit. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Sed aliquam, nisi quis porttitor congue, elit erat euismod orci, ac placerat dolor lectus quis orci. Phasellus consectetuer vestibulum elit. Aenean tellus metus, bibendum sed, posuere ac, mattis non, nunc. Vestibulum fringilla pede sit amet augue. In turpis. Pellentesque posuere. Praesent turpis. Aenean posuere, tortor sed cursus feugiat, nunc augue blandit nunc, eu sollicitudin urna dolor sagittis lacus. Donec elit libero, sodales nec, volutpat a, suscipit non, turpis. Nullam sagittis. Suspendisse pulvinar, augue ac venenatis condimentum, sem libero volutpat nibh, nec pellentesque velit pede quis nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Fusce id purus. Ut varius tincidunt libero. Phasellus dolor. Maecenas vestibulum mollis diam. Pellentesque ut neque.', 'fra'),
(273, 96, 'abstract', '\\[ \\left( \\sum_{k=1}^n a_k b_k \\right)^2 \\leq \\left( \\sum_{k=1}^n a_k^2 \\right) \\left( \\sum_{k=1}^n b_k^2 \\right) \\]', 'eng');
