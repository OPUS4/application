...
/**
 * Basic unit tests for Admin_AutocompleteController class.
 *
 * @covers Admin_AutocompleteController
 */
class Admin_AutocompleteControllerTest extends ControllerTestCase
{
    ...
    public function testAutocompleteGndSubject()
    {
        ...
        $this->assertJson($response);
        $this->assertEquals('[{"value":"Informationssystem","extkey":null}]', $response);
    }
    ...
    public function testEnrichmentTypeDescriptionUnknown()
    {
        ...
        $this->assertJson($response);
        $this->assertEquals('{"typeName":""}', $response);
    }
    ...
    public function testEnrichmentTypeDescriptionGerman()
    {
        ...
        $this->assertJson($response);
        $this->assertEquals('{"typeName":"Bitte geben Sie einen g\u00fcltigen regul\u00e4ren Ausdruck an, der die Wertemenge dieses Typs definiert."}', $response);
    }
