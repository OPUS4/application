...
class Frontdoor_IndexControllerTest extends ControllerTestCase
{
    ...
    /**
     * Tests, if the XSLT has the correct form for the language-attribute for the browser
     */
    public function testLangTransform()
    {
        $this->dispatch('/frontdoor/index/index/docId/146');
        ...
        $this->assertXpath('//li[contains(@class = "titlemain", @lang = "de")]');
        $this->assertXpath('//li[contains(@class = "titlemain", @lang = "en")]');
    }
