...
<xsl:stylesheet version="1.0"
   ...
   <xsl:template name="AddIdentifier">
        ...
        <xsl:choose>
            ...
            <xsl:when test="contains($url, 'doi.acm.org')">
                <xsl:element name="IdentifierDoi">
                    <xsl:attribute name="Value"><xsl:value-of select="substring-after($url,'doi.acm.org/')" /></xsl:attribute>
                </xsl:element>
            </xsl:when>
            <xsl:when test="contains($url, 'doi:')">
                <xsl:element name="IdentifierDoi">
                    <xsl:attribute name="Value"><xsl:value-of select="substring-after($url,'doi:')" /></xsl:attribute>
                </xsl:element>
            </xsl:when>
            <xsl:when test="contains($url, 'DOI:')">
                <xsl:element name="IdentifierDoi">
            ...
            <!-- Borndoerfer: -->
            <xsl:when test="contains($url, 'Webseite unter')">
                <xsl:element name="IdentifierUrl">
                    <xsl:attribute name="Value"><xsl:value-of select="normalize-space(substring-after($url,'Webseite unter'))" /></xsl:attribute>
                </xsl:element>
            </xsl:when>
            <xsl:otherwise>
                <xsl:element name="IdentifierUrl">
   ...
   <xsl:template name="getLastName">
    ...
    <xsl:template name="AddPublicationLists">
        ...
        <xsl:call-template name="AddPublicationList">
             <xsl:with-param name="tag" select="normalize-space($first)" />
        </xsl:call-template>
        <xsl:if test="$remaining">
   ...
   <xsl:template name="AddPublicationList">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$tag = 'Andrae'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">andrae</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Baum'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">baum</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Bujotzek'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">bujotzek</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Burger'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">burger</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Cordes'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">cordes</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Deuflhard'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">deuflhard</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Durmaz'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">durmaz</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Ehrig'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">ehrig</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Erdmann'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">erdmann</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Fackeldey'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">fackeldey</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Hege'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">hege</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Kettner'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">kettner</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Klapproth'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">klapproth</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Klimm'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">klimm</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Lockau'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">lockau</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Nowak'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">nowak</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Pollock'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">pollok</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Pollok'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">pollok</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Pomplun'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">pomplun</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Roeblitz'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">susanna.roeblitz</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Roitzsch'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">roitzsch</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Scharkoi'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">scharkoi</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Schiela'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">schiela</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Schmidt'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">frank.schmidt</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Stoetzel'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">stoetzel</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Weber'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">weber</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Weiser'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">weiser</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Zachow'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">zachow</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Zschiedrich'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person">zschiedrich</xsl:with-param></xsl:call-template></xsl:when>
            ...
            <xsl:when test="$tag = 'borndoerfer'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person" select="$tag" /></xsl:call-template></xsl:when>
 	  <xsl:when test="$tag = 'brandt'"><xsl:call-template name="AddPublicationPerson"><xsl:with-param name="person" select="$tag" /></xsl:call-template></xsl:when>
            ...
            <xsl:when test="$tag = 'MIP'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project" select="$tag" /></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'MATHEON-B20: OPTIMIZATION OF GAS TRANSPORT'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">MATHEON-B20: Optimization of Gas Transport</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'MATHEON-B12: IPSym'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">MATHEON-B12: IPSym</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'IBM'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project" select="$tag" /></xsl:call-template></xsl:when>
            ...
            <xsl:when test="$tag = 'BAM-Thermography'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project" select="$tag" /></xsl:call-template></xsl:when>
            ...
            <xsl:when test="$tag = 'BovCyc'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project" select="$tag"/></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Cardio'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project" select="$tag" /></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'CAS'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project" select="$tag" /></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'confKin'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">Conformation Kinetics</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'conFlow'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">ConFlow</xsl:with-param></xsl:call-template></xsl:when>
            ...
            -->
            <xsl:when test="$tag = 'DTBC-H'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">DTBC Helmholtz</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'DTBC-S'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">DTBC Schrödinger</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'EigenH'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">Eigenvalue Helmholtz</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'EigenM'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">Eigenvalue Maxwell</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Epos'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project" select="$tag" /></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'EUV'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project" select="$tag" /></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Fado'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">FADO</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'FemCyc'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project" select="$tag" /></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Fresnel'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project" select="$tag" /></xsl:call-template></xsl:when>
            ...
            <xsl:when test="$tag = 'Hyper-OC'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project" select="$tag" /></xsl:call-template></xsl:when>
            <!--
            ...
            -->
            <xsl:when test="$tag = 'jump'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">ConfJump</xsl:with-param></xsl:call-template></xsl:when>
            <!--
            ...
            -->
            <xsl:when test="$tag = 'Matheon-A13'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">MATHEON-A13</xsl:with-param></xsl:call-template></xsl:when>
            <!--
            ...
            -->
            <xsl:when test="$tag = 'Matheon-A4'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project" select="$tag" /></xsl:call-template></xsl:when>
            <!--
            ...
            -->
            <xsl:when test="$tag = 'molDesign'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">Molecular Design</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'MolRate'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project" select="$tag" /></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'multiscale'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">MultiscaleVis</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'Nonlin'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">Nonlinear Schrödinger</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'OpenRes'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">Open Resonators</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'PCCA+'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">PCCA+</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'QuantDyn'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project" select="$tag" /></xsl:call-template></xsl:when>
            <!--
            ...
            -->
            <xsl:when test="$tag = 'Sfb-765'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">SFB-765, Teilprojekt C2</xsl:with-param></xsl:call-template></xsl:when>
            <xsl:when test="$tag = 'SFB-765'"><xsl:call-template name="AddPublicationProject"><xsl:with-param name="project">SFB-765, Teilprojekt C2</xsl:with-param></xsl:call-template></xsl:when>
            <!--
            ...
            -->
            <xsl:otherwise>
                <xsl:element name="NoPublicationList">
