...
/**
 * Controller for handling request of resource licence.
 */
class Webapi_LicenceController extends Controller_Rest {

    /**
     * Handle get method for licences.
     *
    ...
    public function getAction() {
        ...
        if ((false === empty($original_action))
            ...
            $result = $licence->getLicence($original_action);
        } else {
            $result = $licence->getAllLicences();
        }
