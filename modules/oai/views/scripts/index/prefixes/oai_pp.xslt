...
<!--  eigentlich soll hier DateCreated stehen, aber welchem Feld
      entspricht das??  -->
...
DateCreated
Contributor (Person und Institutionen)
Publisher hier soll ein String aus versch. Publisher-Daten gebildet
          werden (aus welchen Elementen???)
