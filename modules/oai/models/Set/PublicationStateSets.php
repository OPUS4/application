...
class Oai_Model_Set_PublicationStateSets implements Oai_Model_Set_SetTypeInterface
{
     ...
     * @return string[]
     *
     * TODO return 0 or 1 set for document if it has PublicationState and is visible in OAI
     * TODO return all sets based on PublicationState that contain documents
     */
    public function getSets($document = null)
    {
        ...
        if ($document !== null) {
            ...
            // TODO return all sets based on PublicationState containing documents
            //      should be similar to DocumentTypeSets
        }
    ...
    {
        return $setName->getSetName() === $this->setName;
    }
    ...
    public function configureFinder($finder, $setName)
    {
        ...
        if ($setName->getSetPartsCount() === 2 && in_array($subsetName, $this->getSubsetNames())) {
            $finder->setPublicationState($subsetName);
        } else {
